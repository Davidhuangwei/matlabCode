clear all
cd ~/data/ER02-20110902/
Period=load('ER02-20110902.sts.RUN');
FS = 1250;
FileBase='ER02-20110902';
...
%%
% nhp=length(HP);
% cd /storage/evgeny/data/project/gamma/data/ER02-20110906
cd /storage/evgeny/data/processed/ER02/ER02-20110902/
nhp=length(HP);
