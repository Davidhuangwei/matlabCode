...
%% ticklabel edit
  ui(18)=uicontrol('Style','edit','Units','Normalized',...
			...
			'String',mat2str(get(haold,'XTickLabel')),...
			'Visible','off',...
    			'Value',0,...
                        'CallBack','ezaxes(38)');
...
elseif command == 18
    ...
    if strcmp(get(handles(12,2),'String'),'X')
     set(handles(18,1),'String',ms2strv(get(handles(1,2),'XTickLabel')))
    elseif strcmp(get(handles(12,2),'String'),'Y')
     set(handles(18,1),'String',ms2strv(get(handles(1,2),'YTickLabel')))
    else
     set(handles(18,1),'String',ms2strv(get(handles(1,2),'ZTickLabel')))
    end
    set(handles(18,1),'Visible','on')
elseif command == 38
    handles = get(gcf,'UserData');
     if strcmp(get(handles(12,2),'String'),'X')
     set(handles(1,2),'XTickLabel',ms2strv(get(handles(18,1),'String')))
    elseif strcmp(get(handles(12,2),'String'),'Y')
     set(handles(1,2),'YTickLabel',ms2strv(get(handles(18,1),'String')))
    else
     set(handles(1,2),'ZTickLabel',ms2strv(get(handles(18,1),'String')))
    end
