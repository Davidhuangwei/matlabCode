...
if nargin == 0
        ...
        set(xhr_plot,'WindowButtonDownFcn','crssrms(''down'');'); 
...
set(xhr_plot,'WindowButtonMotionFcn','crssrms(''move'');');
                set(xhr_plot,'WindowButtonUpFcn','crssrms(''up'');');
        ...
        %convert to ms
        	...
        	set(y_num,'String',num2str(dy(1),3));
                indx=find(xhr_xdata > dx(1) & xhr_xdata < dx2 )
                rms =xhr_ydata(indx)
