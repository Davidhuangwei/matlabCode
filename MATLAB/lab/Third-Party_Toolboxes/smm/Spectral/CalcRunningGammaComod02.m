function CalcRunningGammaComod02(spectraDir,fileBaseCell,gammaFreqRange,forder,thetaFreqRange,varargin)
...
%             try
                if ~isempty(to)
                    for i=1:length(to)
%                         [fileBase '_' num2str(gammaFreqRange(1)) '-' ...
%                             num2str(gammaFreqRange(2)) 'Hz_Forder' num2str(forder) fileExt '.100DBpow']
