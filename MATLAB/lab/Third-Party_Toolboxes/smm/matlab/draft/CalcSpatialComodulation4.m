function CalcSpatialComodulation4(fileBaseMat,fileExt,nchannels,channels,chanMat,badchan,winLength,overlap,NW,thetaFreq,gammaFreq)
...
keyboard
save(['spatialComodData4_grid' num2str(binSize)],'spatialComodData');
