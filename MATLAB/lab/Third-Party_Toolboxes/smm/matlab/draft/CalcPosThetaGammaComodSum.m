function [pos_sum, pow_sum] = CalcPosPowSum(tasktype,fileBaseMat,fileNameFormat,fileext,nchannels,channels,lowband,highband,forder,avgfilorder,dbBool,savepowsum,savefilt,savepow,savedspow,trialtypesbool,mazelocationsbool)
%function [pos_sum, pow_sum] = CalcPosPowSum(tasktype,fileBaseMat,fileNameFormat,fileext,nchannels,channels,lowband,highband,forder,avgfilorder,dbBool,savepowsum,savefilt,savepow,savedspow,trialtypesbool,mazelocationsbool)
% 
