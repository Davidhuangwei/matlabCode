function [pos_sum, pow_sum] = calcpospowsum3(tasktype,fileBaseMat,fileNameFormat,fileext,nchannels,channels,lowband,highband,forder,avgfilorder,savepowsum,savefilt,savepow,savedspow,trialtypesbool,mazelocationsbool)
% function [pos_sum, pow_sum] = calcpospowsum3(tasktype,fileBaseMat,fileNameFormat,fileext,nchannels,channels,lowband,highband,forder,avgfilorder,savepowsum,savefilt,savepow,savedspow,trialtypesbool,mazelocationsbool)
% 
