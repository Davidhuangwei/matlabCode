function plotpowmapsbat5(pos_sum,pow_sum,chanMat,DB,badchan,plot_low_thresh,samescale,minscale,maxscale)
% function plotpowmapsbat5(pos_sum,pow_sum,chanMat,DB,samescale,minscale,maxscale)
