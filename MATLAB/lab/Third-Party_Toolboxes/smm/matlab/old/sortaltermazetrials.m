    ...
    while (~isempty(intrigzone) & ~isempty(notintrigzone))
        ...
        while (tryagain == 1)
            ...
            case 'g'
                if choice == 'correct  ',
                    if ending == 'right',
                        correctright(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        cr=cr+1;     
                    else
                        correctleft(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        cl=cl+1;
                    end
                else
                    if ending == 'right',
                        incorrectright(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        ir=ir+1;     
                    else
                        incorrectleft(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        il=il+1;
                    end
                end
            case 'p'
                if choice == 'correct  ',
                    if ending == 'right',
                        pondercorrectright(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        crp=crp+1;
                    else
                        pondercorrectleft(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        clp=clp+1;
                    end
                else
                    if ending == 'right',
                        ponderincorrectright(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        irp=irp+1;
                    else
                        ponderincorrectleft(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        ilp=ilp+1;
                    end
                end
            case 'b'
                if choice == 'correct  ',
                    if ending == 'right',
                        badcorrectright(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        crb=crb+1;
                    else
                        badcorrectleft(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        clb=clb+1;
                    end
                else
                    if ending == 'right',
                        badincorrectright(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        irb=irb+1;
                    else
                        badincorrectleft(newtrialtrigger(1):endoftrial(end))=1;
                        tryagain = 0;
                        ilb=ilb+1;
                    end
                end
