function [y, f]=calcchanspectrum7(filebasemat,fileext,nchannels,channels,nFFT,nOverlap,WinLength,Fs,removeexp,wholeFileBool,trialTypesBool,mazeLocationsBool)
% function [y, f]=calcchanspectrum7(filebasemat,fileext,nchannels,channels,nFFT,nOverlap,WinLength,Fs,removeexp,wholeFileBool,trialTypesBool,mazeLocationsBool)
% uses readmulti to read data
