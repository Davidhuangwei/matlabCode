...
SW = load('l23-01-016/l23-01-016.sw')/16;

chselect = [0 4 8 12 16 20 24]+1;
if ~exist('eeg');
eeg = readmulti('l23-01-016/l23-01-016.eeg',31,chselect);
end;
...
ripple_coherence = COHM;
save ripple_c ripple_coherence;
