...
mazeLocationsBool = [0  0  0  1  1  1   1   1   1];
                  % rp lp dp cp ca rca lca rra lra
[allNoPortsY allNoPortsF] = calcchanspectrum8(fileBaseMat,fileext,nchannels,channels,nFFT,nOverlap,WinLength,Fs,NW,removeexp,0,trialTypesBool,mazeLocationsBool);

mazeLocationsBool = [1  1  1  1  1  1   1   1   1];
                  % rp lp dp cp ca rca lca rra lra
[allY allF] = calcchanspectrum8(fileBaseMat,fileext,nchannels,channels,nFFT,nOverlap,WinLength,Fs,NW,removeexp,0,trialTypesBool,mazeLocationsBool);
