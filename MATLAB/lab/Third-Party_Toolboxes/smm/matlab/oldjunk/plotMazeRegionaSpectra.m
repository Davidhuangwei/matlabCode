function plotMazeRegionsSpectra(tasktype,fileBaseMat,fileext,fileNameFormat,chanMat,badChannels,NW,includePortsBool,percentageBool,samescale,dbscale,removeexp)
