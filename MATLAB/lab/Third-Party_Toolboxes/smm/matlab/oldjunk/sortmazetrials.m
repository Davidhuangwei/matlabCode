...
while (1)
    ...
    newtrialtrigger = notintrigzone(find(notintrigzone>=begin));
    ...
    plot(whldat(begin:endoftrial(1),2),368-whldat(begin:endoftrial(1),1),'.','color',[1 0 0],'markersize',7,'linestyle','none');
    set(gca,'xlim',[0 240],'ylim',[0 368]);
    tryagain = 1;
    while (tryagain == 1)
        ...
        case 'x'
            tryagain = 0;
        case 'cr'
            correctright = [correctright begin:endoftrial(1)];
            tryagain = 0;
        case 'ir'
            incorrectright = [incorrectright begin:endoftrial(1)];
            tryagain = 0;
        case 'cl'
            correctleft = [correctleft begin:endoftrial(1)];
            tryagain = 0;
        case 'il'
            incorrectleft = [incorrectleft begin:endoftrial(1)];
            tryagain = 0;
        case 'crp'
            pondercorrectright = [pondercorrectright begin:endoftrial(1)];
            tryagain = 0;
        case 'irp'
            ponderincorrectright = [ponderincorrectright begin:endoftrial(1)];
            tryagain = 0;
        case 'clp'
            pondercorrectleft = [pondercorrectleft begin:endoftrial(1)];
            tryagain = 0;
        case 'ilp'
            ponderincorrectleft = [ponderincorrectleft begin:endoftrial(1)];
            tryagain = 0;
        case 'crb'
            badcorrectright = [badcorrectright begin:endoftrial(1)];
            tryagain = 0;
        case 'irb'
            badincorrectright = [badincorrectright begin:endoftrial(1)];
            tryagain = 0;
        case 'clb'
            badcorrectleft = [badcorrectleft begin:endoftrial(1)];
            tryagain = 0;
        case 'ilb'
            badincorrectleft = [badincorrectleft begin:endoftrial(1)];
            tryagain = 0;
        otherwise
