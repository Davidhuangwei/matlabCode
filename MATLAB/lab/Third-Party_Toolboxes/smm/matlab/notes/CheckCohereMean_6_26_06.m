function CheckCohereMean_6_26_06(animal)
    thetaFreqRange = [6 12];
...
ReportFigSM(1,['/u12/smm/public_html/NewFigs/CohCheck_6_24_06/' analRoutine '/' animal '/GammaCohMean/'])
...
ReportFigSM(1,['/u12/smm/public_html/NewFigs/CohCheck_6_24_06/' analRoutine '/' animal '/thetaCohPeakLMF/'])
...
return
    ...
    ReportFigSM(1:nextFig-1,['/u12/smm/public_html/NewFigs/CohCheck_6_24_06/' analRoutine animal '/GammaCohMean/'])
    ...
    ReportFigSM(1:nextFig-1,['/u12/smm/public_html/NewFigs/CohCheck_6_24_06/' analRoutine animal '/GammaSpec/'])
    end
    ...
    ReportFigSM(1:nextFig-1,['/u12/smm/public_html/NewFigs/CohCheck_6_24_06/' analRoutine animal '/thetaCohPeakLMF/'])
    ...
    ReportFigSM(1:nextFig-1,['/u12/smm/public_html/NewFigs/CohCheck_6_24_06/' analRoutine animal '/ThetaSpec/'])
    end
