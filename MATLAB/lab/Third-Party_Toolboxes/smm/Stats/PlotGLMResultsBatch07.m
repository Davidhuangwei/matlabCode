...
[multiFreqBool interpFunc] = DefaultArgs(varargin,{0,'linear'});
% function PlotGLMResultsBatch07(dirname,inNameNote,depVarCell,fileExt,varargin)
% [multiFreqBool interpFunc] = DefaultArgs(varargin,{0,'linear'});
...
for j=1:length(depVarCell)
    PlotGLMResults07(dirname,inNameNote,[depVarCell{j} selChanName],fileExt,multiFreqBool,interpFunc,reportFigBool)
end
