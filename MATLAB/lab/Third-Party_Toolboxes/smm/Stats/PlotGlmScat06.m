...
for analBattery=[1:26]
    switch analBattery
        ...
        case 3
            depVar = 'thetaCohMean6-12Hz'; categMeansYlim = [-1 1]; selChan = 1;
        case 4
            depVar = 'thetaCohMean6-12Hz'; categMeansYlim = [-1 1]; selChan = 2;
        case 5
            depVar = 'thetaCohMean6-12Hz'; categMeansYlim = [-1 1]; selChan = 3;
        case 6
            depVar = 'thetaCohMean6-12Hz'; categMeansYlim = [-1 1]; selChan = 4;
        case 7
            depVar = 'thetaCohMean6-12Hz'; categMeansYlim = [-1 1]; selChan = 5;
        case 8
            depVar = 'thetaCohMean6-12Hz'; categMeansYlim = [-1 1]; selChan = 6;
        case 9
