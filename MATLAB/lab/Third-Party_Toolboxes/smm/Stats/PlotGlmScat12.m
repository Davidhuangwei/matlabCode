...
% [analDirs betaClim reportFigBool dirname saveDir bonfFactor statAlpha plotColors] = ...
...
[analDirs betaXlim reportFigBool dirname saveDir bonfFactor statAlpha plotColors] = DefaultArgs(varargin,...
    {analDirs,[],1,'GlmWholeModel08','MazePaper/',1,0.01,...
...
%         [mu stDev pVal] = GlmResultsCalcMuStdP(catPlotData,1);
        [mu stDev pVal] = GlmResultsCalcMedC95P(catPlotData,1);
