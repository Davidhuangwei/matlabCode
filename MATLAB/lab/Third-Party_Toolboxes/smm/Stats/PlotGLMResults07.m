function PlotGLMResults07(glmVersion,analRoutine,depVar,fileExt,multiFreqBool,interpFunc,reportFigBool,categMeansCLim)
%function PlotGLMResults01(glmVersion,analRoutine,depVar,fileExt,multiFreqBool,interpFunc,reportFigBool)
filename = depVar;
load([glmVersion '/' analRoutine '/' fileExt '/' depVar '.mat'])
fo = infoStruct.fo;
...
if reportFigBool
    ...
    ReportFigSM(1:nextFig-1,Dot2Underscore([pwd '/NewFigs/' glmVersion '/' analRoutine '/' fileExt '/']));
end
