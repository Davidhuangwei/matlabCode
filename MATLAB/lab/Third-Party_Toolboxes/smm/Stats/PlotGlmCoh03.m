        ...
        for k=1:length(animalDirs)
            ...
            for n=1:length(anatFields)
                ...
                for m=1:length(varNames);
                    %varNames{m}
                    %try 
                        coeffs.(GenFieldName(varNames{m})).(anatFields{n}).(animalDirs{k}(13:18))(1:length(goodChans),j) = ...
                            model.coeffs(m,goodChans)';
                    %catch keyboard
                    %end
                    if strcmp(varNames{m},'Constant')
                        constantCoeff.(GenFieldName(varNames{m})).(anatFields{n}).(animalDirs{k}(13:18))(1:length(goodChans),j) = ...
                            model.coeffs(m,goodChans)';
                    end
                end
                %%%%%% categMeans %%%%%%%%
                if ~isempty(model.categMeans)
                    for q = 1:length(model.categMeans)
                        ...
                        for m=1:length(varNames);
                            ...
                            categMeans{q}.(GenFieldName(varNames{m})).(anatFields{n}).(animalDirs{k}(13:18))(1:length(goodChans),j) = ...
                                squeeze(model.categMeans{q}(m,1,goodChans));
                            %- mean(model.categMeans{q}(:,1,goodChans)));
                        end
                    end
                ...
                for m=1:length(varNames);
                    assumPlot.residNormPs.(GenFieldName(varNames{m})).(anatFields{n}).(animalDirs{k}(13:18))(1:length(goodChans),j) = ...
                ...
                for m=1:length(varNames);
                    assumPlot.residMeanPs.(GenFieldName(varNames{m})).(anatFields{n}).(animalDirs{k}(13:18))(1:length(goodChans),j) = ...
                        tempData(m,goodChans)';
                end
                %                 %%%%%% residNormPs %%%%%%%%
                ...
                %                     residNormPs.(GenFieldName(varNames{m})).(anatFields{n}).(animalDirs{k}(13:18))(1:length(goodChans),j) = ...
                ...
                %                     residMeanPs.(GenFieldName(varNames{m})).(anatFields{n}).(animalDirs{k}(13:18))(1:length(goodChans),j) = ...
                %                         temp.(varNames{m})(goodChans);
                %                end
                %%%% contDwPvals %%%%%
                ...
                for m=1:length(varNames);
                    assumPlot.contDwPvals.(GenFieldName(varNames{m})).(anatFields{n}).(animalDirs{k}(13:18))(1:length(goodChans),j) = ...
                        tempData(m,goodChans)';
                end
                %%%% categDwPvals %%%%%
                ...
                for m=1:length(varNames);
                    assumPlot.categDwPvals.(GenFieldName(varNames{m})).(anatFields{n}).(animalDirs{k}(13:18))(1:length(goodChans),j) = ...
                        tempData(m,goodChans)';
                end
                %%%% prllPvals %%%%%
                ...
                for m=1:length(varNames);
                    assumPlot.prllPvals.(GenFieldName(varNames{m})).(anatFields{n}).(animalDirs{k}(13:18))(1:length(goodChans),j) = ...
                        tempData(m,goodChans)';
                end
                %%%%%% prllPvals %%%%%%%%
