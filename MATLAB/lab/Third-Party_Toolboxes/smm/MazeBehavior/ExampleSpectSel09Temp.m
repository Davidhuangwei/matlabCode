function  ExampleSpectSel07(fileBaseCell,fileext,nchannels,lowband,highband)
%Fs = 1250;
lowband = 40;
highband = 120;
forder = 312;
...
%                 plot([plotStart+endEEG-beginEEG plotStart+endEEG-beginEEG],freqLim,['--' plotColors(k)])
                ...
                if k==length(fields)
                    text(endEEG-exitDelayEEG+2+enterDelayEEG-beginRawEEG + 250,mean(freqLim),selChanNames{m});
                end
                ylabel('Freq');
%                 shading interp
