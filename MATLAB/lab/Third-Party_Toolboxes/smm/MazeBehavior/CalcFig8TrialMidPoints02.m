function trialMidRegionsStruct = CalcTrialMidPoints02(allMazeRegions,waterPorts,startArm,mazeRegionsStruct,plotFig,plotWindow)
...
while ~isempty(trialbegin),
    enterWP = trialbegin(1) + find(waterPorts((trialbegin(1)+1):end,1)~=-1,1);
    if isempty(enterWP)
        breaking = 1
        break;
    end
