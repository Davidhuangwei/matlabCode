function  ExampleSpectSel06(filebasemat,fileext,nchannels,channel,lowband,highband)
...
figure(1)
set(gcf,'name',['GammaSpectExamplesSelected_' num2str(lowband) '-' num2str(highband) 'Hz_03'])
...
% plot limits
        ...
        for m=1:length(chans)
                ...
                %smoothWave = 10.*log10(Conv2Trim(gaussianX,gaussianY,wave'))';
