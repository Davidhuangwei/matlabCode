...
for k=1:length(fileBaseCell)
    ...
    [RippleTimeExc, taxis]=ripdetecthsmm([fileBase '/' fileBase],eegNChan,rippDetChans,plotBool,0.75,1); %,Mult,shanknumber,drugconditions,drugtimes)
...
%      plot([1:length(plotExc)]/eegSamp,plotTime,'.g')
   ...
   if plotBool
    ...
    save(outName,SaveAsV6,'segs','time','timeInc','timeExc','infoStruct');
end
