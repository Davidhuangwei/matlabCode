function PlotTrigAveSpect(animalDirs,filesNameCell,fileExt,trigFileBase,varargin)
chanLocVersion = DefaultArgs(varargin,'Min');
% function PlotTrigAveSpect(animalDirs,filesNameCell,fileExt,trigFileBase,varargin)
% chanLocVersion = DefaultArgs(varargin,'Min');

[outSpec fo to coi outSeg] = LoadTrigAveSpec(animalDirs,filesNameCell,fileExt,...
    trigFileBase,chanLocVersion);
% [stdSpec fo to coi outSeg] = LoadTrigStdSpec(animalDirs,filesNameCell,fileExt,...
%     trigFileBase,chanLocVersion);
...
titleBase = {[trigFileBase 'Spec' fileExt]};
figTitleBase = [trigFileBase 'Spec' fileExt];
