function PlotRippTrigAveCoh(animalDirs,fileExt,segLen,segRestriction,varargin)
...
% 
[outCoh fo to coi outNumSeg3] = LoadRippTrigAveCoh(animalDirs,fileExt,segLen,segRestriction{1},chanLocVersion);
