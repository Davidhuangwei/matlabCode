function [outSpec fo to coi outSeg] = LoadRippTrigAveCoh(animalDirs,fileExt,segLen,segRestriction,varargin)
        ...
        try
            for r=1:size(selChan,1)
                ...
                for j=1:length(sleepFiles)
                    inFile = [sleepFiles{j} '/RippTrigAveCoh_' segRestriction num2str(segLen)...
