...
%             try
             %GlmWholeAnalysisBatch05_2('CalcRunningSpectra9_noExp',analRoutine{m},'01',fileExtCell{j},depVarCell)
                GlmWholeAnalysisBatch07('RemVsRun01_noExp',analRoutine{m},'01',fileExtCell{j},depVarCell)
%             catch
...
for m=1:length(analRoutine)
    for j=1:length(fileExtCell)
        %PlotGLMResults07('GlmWholeModel07','RemVsRunGood_01','gammaPowIntg40-100Hz','.eeg',0,'linear',1)
       PlotGLMResultsBatch07('GlmWholeModel07',[analRoutine{m} '_01'],depVarCell,fileExtCell{j})
          %try
