...
%                 PlotGlmCoh09(depVarCell,spectAnalBaseCell{n},fileExtCell{j},chanLocVersion{k},[analRoutine{m} '_01'],animalDirs,scaleCell{m},reportFigBool,[],saveDir,statAlpha,1,1)
               PlotGlmBarh04(depVarCell,spectAnalBaseCell{n},fileExtCell{j},chanLocVersion{k},[analRoutine{m} '_01'],animalDirs,scaleCell{m},reportFigBool,[],saveDir,statAlpha)
%                PlotGlmScat10(depVarCell,spectAnalBaseCell{n},fileExtCell{j},chanLocVersion{k},[analRoutine{m} '_01'],animalDirs,scaleCell{m},reportFigBool,[],saveDir,statAlpha)
           end
        end
    end
end

PlotBehavHist03(animalDirs(1),depVarCell{1},fileExtCell{1},spectAnalBaseCell{1},analRoutine{1},100,[],[],1)
...
PlotBehavAnatMap04(depVarCell{1},fileExtCell{1},spectAnalBaseCell{1},analRoutine{1})

PlotGLMResults08('GlmWholeModel08',[analRoutine{1} '_01'],depVarCell{1},spectAnalBaseCell{1},fileExtCell{1},0,'linear',0,[-0.05 0.05])
...
PlotBehavPowerSpectra05(animalDirs,depVarCell{1},fileExtCell{1},spectAnalBaseCell{1},analRoutine{1},[],1,0,[35 85]) 
...
PlotBehavCohSpectra02(animalDirs,depVarCell{1},fileExtCell{1},spectAnalBaseCell{1},analRoutine{1})
...
PlotBehavPhaseScat01(analDirs,depVarCell{1},fileExtCell{1},spectAnalBaseCell{1},analRoutine{1},'PhasePaper/EachAnimal/sm9603/')
