...
for j=1:length(analDirs)
    ...
    for k=1:size(fileExts,1)
        CalcRunningSpectra14('noExp',files,fileExts{k,1},fileExts{k,2},6,1250,0,...
...
for j=1:length(analDirs)
    ...
    for k=1:size(fileExts,1)
        CalcRunningSpectra15('noExp',files,fileExts{k,1},fileExts{k,2},6,1250,0,...
            [4 12],[40 120],[],[0 0 0 0 0 0 0 0 0],5,[],0)
    end
end
...
for j=1:length(analDirs)
    ...
    for k=1:size(fileExts,1)
        CalcRemSpectra05('allTimes',files,fileExts{k,1},fileExts{k,2},6,1250,[4 12],[40 120])
    end
end

funcs2run = {...
    'CalcRemSpectraTime02',...
    'CalcWaveletSpectra01',...
    'CalcThetaFreq03',...
    'CalcThetaGammaRange01',...
    }
...
for j=1:length(analDirs)
    ...
    files = LoadVar('FileInfo/RemFiles')
    for k=1:size(fileExts,1)
        CalcRemSpectra06('allTimes',files,fileExts{k,1},fileExts{k,2},6,1250,[4 12],[40 120])
    end
end
