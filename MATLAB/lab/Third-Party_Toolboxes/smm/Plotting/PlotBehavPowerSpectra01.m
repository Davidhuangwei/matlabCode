...
[holdOnBool,plotColors,analDirs,glmVersion,midPointsBool,minSpeed,winLength] ...
    = DefaultArgs(varargin,{1,[0 0 0;1 0 0;0 1 0;0 0 1],{[pwd '/']},'GlmWholeModel07',1,0,626});
...
depCell = Struct2CellArray(LoadDesigVar(cell2mat(intersect(fileBaseCell,files.name)),dirName,[depVar '.yo'],trialDesig),[],1);
foCell = Struct2CellArray(LoadDesigInfo(cell2mat(intersect(fileBaseCell,files.name)),dirName,[depVar '.fo'],trialDesig),[],1);
