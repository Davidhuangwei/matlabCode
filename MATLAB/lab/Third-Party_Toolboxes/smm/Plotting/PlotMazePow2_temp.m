function PlotMazePow2(taskType,fileBaseCell,fileNameFormat,fileExt,freqRange,winLength,NW,peakBool,chanMat,varargin)
...
[badchan, saveMazePow, calcZ, normalizeBool, dbBool, colorLimits, textBool, plotRes, plot_low_thresh] = ...
    DefaultArgs(varargin,{0, 0, 0, 0, 0, [], 1, 3, 0.01});
