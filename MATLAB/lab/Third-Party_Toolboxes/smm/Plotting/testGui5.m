function varargout = testGui5(varargin)
% TESTGUI5 M-file for testGui5.fig
%      TESTGUI5, by itself, creates a new TESTGUI5 or raises the existing
%      singleton*.
%
%      H = TESTGUI5 returns the handle to a new TESTGUI5 or the handle to
%      the existing singleton*.
%
%      TESTGUI5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TESTGUI5.M with the given input arguments.
%
%      TESTGUI5('Property','Value',...) creates a new TESTGUI5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before testGui5_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to testGui5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help testGui5

% Last Modified by GUIDE v2.5 05-Oct-2005 23:45:14

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @testGui5_OpeningFcn, ...
                   'gui_OutputFcn',  @testGui5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before testGui5 is made visible.
function testGui5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to testGui5 (see VARARGIN)

% Choose default command line output for testGui5
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes testGui5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = testGui5_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on selection change in includedTypes.
function includedTypes_Callback(hObject, eventdata, handles)
% hObject    handle to includedTypes (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = get(hObject,'String') returns includedTypes contents as cell array
%        contents{get(hObject,'Value')} returns selected item from includedTypes


% --- Executes during object creation, after setting all properties.
function includedTypes_CreateFcn(hObject, eventdata, handles)
% hObject    handle to includedTypes (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function xVarIncCritInput_Callback(hObject, eventdata, handles)
% hObject    handle to xVarIncCritInput (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of xVarIncCritInput as text
%        str2double(get(hObject,'String')) returns contents of xVarIncCritInput as a double


% --- Executes during object creation, after setting all properties.
function xVarIncCritInput_CreateFcn(hObject, eventdata, handles)
% hObject    handle to xVarIncCritInput (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in subplot.
function subplot_Callback(hObject, eventdata, handles)
% hObject    handle to subplot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = get(hObject,'String') returns subplot contents as cell array
%        contents{get(hObject,'Value')} returns selected item from subplot
...
function yVarIncCritInput_Callback(hObject, eventdata, handles)
% hObject    handle to yVarIncCritInput (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of yVarIncCritInput as text
%        str2double(get(hObject,'String')) returns contents of yVarIncCritInput as a double


% --- Executes during object creation, after setting all properties.
function yVarIncCritInput_CreateFcn(hObject, eventdata, handles)
% hObject    handle to yVarIncCritInput (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function cVarExclCritInputx_Callback(hObject, eventdata, handles)
% hObject    handle to cVarExclCritInputx (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of cVarExclCritInputx as text
%        str2double(get(hObject,'String')) returns contents of cVarExclCritInputx as a double


% --- Executes during object creation, after setting all properties.
function cVarExclCritInputx_CreateFcn(hObject, eventdata, handles)
% hObject    handle to cVarExclCritInputx (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
