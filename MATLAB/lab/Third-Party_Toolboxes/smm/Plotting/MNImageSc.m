function [colorLimits, figureNum] = MNImageSc(subPlotsCell,sameScaleBool,colorLimits,figureNum,anatOverlayName)
% function MNImageSc(subPlotsCell,colorLimits)
% ImagesCell is an m x n cell array whose arrangement determines the (x,y)
