function PlotMazePowNormByControl(expTaskType,expFileBaseMat,controlTaskType,controlFileBaseMat,fileNameFormat,fileExt,lowCut,highCut,fOrder,chanMat,badchan,dbBool,samescale,colorLimits,textBool,plotRes,plot_low_thresh)
...
if fileNameFormat == 2,
    expSmoothMazePowFile = [expTaskType '_' expFileBaseMat(1,:) '-' expFileBaseMat(end,[8:10]) ...
        fileExt '_' num2str(lowCut) '-' num2str(highCut) 'Hz_SmoothMazePow' DB '.mat'];

    expPos_pow_sumFile = [expTaskType '_' expFileBaseMat(1,:) '-' expFileBaseMat(end,[8:10]) ...
        fileExt '_' num2str(lowCut) '-' num2str(highCut) 'Hz_pos_pow_sum' DB '.mat'];
    
    controlSmoothMazePowFile = [controlTaskType '_' controlFileBaseMat(1,:) '-' controlFileBaseMat(end,[8:10]) ...
        fileExt '_' num2str(lowCut) '-' num2str(highCut) 'Hz_SmoothMazePow' DB '.mat'];

    controlPos_pow_sumFile = [controlTaskType '_' controlFileBaseMat(1,:) '-' controlFileBaseMat(end,[8:10]) ...
        fileExt '_' num2str(lowCut) '-' num2str(highCut) 'Hz_pos_pow_sum' DB '.mat'];
