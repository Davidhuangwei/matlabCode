function plotAnatPowNormByControl8(expTaskType,expFileBaseMat,controlTaskType,controlFileBaseMat,fileNameFormat,fileExt,chanMat,badchan,lowCut,highCut,onePointBool,samescale,dbscale,plotAnatBool,textBool)
...
[colorLimits, figureNum] = nimagesc(figureMats,1,colorLimits,1,anatFileName);
...
nimagesc(figureMats,1,colorLimits,2,anatFileName);
...
[colorLimits, figureNum] = nimagesc(figureMats,1,colorLimits,3,anatFileName);
...
nimagesc(figureMats,1,colorLimits,4,anatFileName);
...
nimagesc(figureMats,1,colorLimits,5,anatFileName);
...
nimagesc(figureMats,1,[],6,anatFileName);

figureMats = {{sdExpNormContPowerPerChan,'sd ' expTaskType ' Norm ' controlTaskType}};
nimagesc(figureMats,1,[],7,anatFileName);
...
nimagesc(figureMats,1,[-1 1],8,anatFileName);
...
nimagesc(figureMats,0,[],9,anatFileName);
