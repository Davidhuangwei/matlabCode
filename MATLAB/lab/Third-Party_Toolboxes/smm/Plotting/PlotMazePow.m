function PlotMazePow(taskType,fileBaseCell,fileNameFormat,fileExt,freqRange,winLength,NW,peakBool,chanMat,varargin)
        ...
        for x=1:chan_x
            ...
            if isempty(find(badchan==chanMat(y,x,z))), % if the channel isn't bad
                ...
                if calcZ
                    ...
                    plotMazePow(:,:,chanMat(y,x,z)) = (mazePow(:,:,chanMat(y,x,z))-meanPowthisChan)./sdPowthisChan;
