function plotpowmapsbat10(taskType,fileBaseMat,fileNameFormat,fileExt,lowCut,highCut,fOrder,chanMat,badchan,...
    saveMazePow,calcZ,percentageBool,DB,samescale,minscale,maxscale,textBool,plotRes,plot_low_thresh)
% function plotpowmapsbat10(taskType,fileBaseMat,fileNameFormat,fileExt,lowCut,highCut,fOrder,chanMat,badchan,saveMazePow,calcZ,percentageBool,DB,samescale,minscale,maxscale,textBool,plotRes,plot_low_thresh)
%
