...
for a=1:length(analDirs)
    ...
    rateTrialsByCells = LoadDesigVar(fileBaseCell,dirName,'unitCCG.rate',trialDesig);
    spectTrialsByCells = LoadDesigVar(fileBaseCell,dirName,'unitCCG.yo',trialDesig);
    elCluList = LoadField([fileBaseCell{1} '/' spectAnalDir 'unitCCG.elClu']);
    to = LoadField([fileBaseCell{1} '/' spectAnalDir 'unitCCG.to']);
