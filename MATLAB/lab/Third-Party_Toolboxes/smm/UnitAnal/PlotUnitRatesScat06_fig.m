...
tempDataCell(:,4) = {'w'};
errBarsCell = errBarsCell(goodInd,:);
errBarsCell(:,4) = {'w'};
...
UnitLinePlotHelper(tempDataCell,[-0.5 .5],infoText,figName,colNamesCell,reportFigBool,outDir,0.05,bonfFactor,2,1.1)
UnitLineSquarePlotHelper(tempDataCell,[-0.5 .5],infoText,figName,colNamesCell,reportFigBool,outDir,0.05,bonfFactor,2,1.1)
UnitLineShapePlotHelper(tempDataCell,[-0.35 .35],infoText,figName,colNamesCell,reportFigBool,outDir,0.05,bonfFactor,2,1.1)
...
UnitBarPlotHelper(tempDataCell,[-0.3 .3],infoText,figName,colNamesCell,reportFigBool,outDir,0.05,bonfFactor,2,1.1)

UnitBarPlotHelper(tempDataCell,[],infoText,figName,colNamesCell,reportFigBool,outDir,0.05,bonfFactor,2,1.1,errBarsCell)
