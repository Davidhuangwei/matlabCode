...
[xLimits infoText figName colNamesCell reportFigBool saveDir plotColors screenHeight xyFactor] = ...
    DefaultArgs(varargin,{[],{'noInfo'},[],{},0,'./','rgbk',11,1.5});
            ...
            for n=1:length(col{4})
                ...
                for p=1:length(col{5})
                    ...
                    if ~isempty(tempData) & length(tempData)==1
                        ...
                        temp1 = mean(tempData{1}(goodCells,:),1);
