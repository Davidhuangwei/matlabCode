...
for j=1:length(timeRangeCell)
    ...
    infoText = {['Unit Firing CCG - btwCell']; ['timeRange=' num2str(timeRange(1)) '-' num2str(timeRange(2)) 'ms']; ...
        [normalization ' bin=' num2str(binSize) ' ' bcText ' minRate=' num2str(rateMin)]};
    figName = ['UnitCCG_btwCell_' num2str(timeRange(1)) '-' num2str(timeRange(2)) 'ms_' normalization bcText ...
        '_bin' num2str(binSize)];
    outDir = [saveDir SC(analRoutine) 'CCG/'];
...
for j=1:length(timeRangeCell)
    ...
    infoText = {['Unit Firing CCG - wInCell']; ['timeRange=' num2str(timeRange(1)) '-' num2str(timeRange(2)) 'ms']; ...
        [normalization ' bin=' num2str(binSize) ' ' bcText ' minRate=' num2str(rateMin)]};
    figName = ['UnitCCG_wInCell_' num2str(timeRange(1)) '-' num2str(timeRange(2)) 'ms_' normalization bcText ...
        '_bin' num2str(binSize)];
    outDir = [saveDir SC(analRoutine) 'CCG/'];
...
for j=1:length(timeRangeCell)
    ...
    infoText = {['Unit Firing ACG - btwCell']; ['timeRange=' num2str(timeRange(1)) '-' num2str(timeRange(2)) 'ms']; ...
        [normalization ' bin=' num2str(binSize) ' ' bcText ' minRate=' num2str(rateMin)]};
    figName = ['UnitACG_btwCell_' num2str(timeRange(1)) '-' num2str(timeRange(2)) 'ms_' normalization bcText ...
        '_bin' num2str(binSize)];
    outDir = [saveDir SC(analRoutine) 'ACG/'];
...
for j=1:length(timeRangeCell)
    ...
    infoText = {['Unit Firing ACG - wInCell']; ['timeRange=' num2str(timeRange(1)) '-' num2str(timeRange(2)) 'ms']; ...
        [normalization ' bin=' num2str(binSize) ' ' bcText ' minRate=' num2str(rateMin)]};
    figName = ['UnitSCG_wInCell_' num2str(timeRange(1)) '-' num2str(timeRange(2)) 'ms_' normalization bcText ...
        '_bin' num2str(binSize)];
    outDir = [saveDir SC(analRoutine) 'ACG/'];
