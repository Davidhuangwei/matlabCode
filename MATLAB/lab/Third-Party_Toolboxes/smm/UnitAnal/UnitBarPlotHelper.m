...
[xLimits commonXLim infoText figName colNamesCell reportFigBool saveDir alpha bonfFactor subplotHeight xyFactor,errorBarsCell] = ...
    DefaultArgs(varargin,{[],1,{'noInfo'},[],{},0,'./',0.05,1,2,1.0,0});
