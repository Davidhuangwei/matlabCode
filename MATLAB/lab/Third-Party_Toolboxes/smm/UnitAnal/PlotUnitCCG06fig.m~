...
for j=1:length(timeRangeCell)
    ...
    UnitBoxPlotHelper(tempDataCell,infoText,figName,colNamesCell,reportFigBool,outDir)
                ...
                %%%%%%%%%%%%%%%%%% fig printing %%%%%%%%%%%%%%%%
%         tempDataCell =
%         UnitCellRateThreshHelper(dataCell2,cellRateMin,rateCell2,wInBool);
        tempDataCell = UnitMeanHelper(dataCell,2,to,timeRange);
...
UnitBarPlotHelper(tempDataCell,[-4 4],infoText,figName,tempColNamesCell,reportFigBool,outDir,0.05,7)
