function CalcBadChanAnal(animal,behavior,fileBaseCell,beginTimeMat,nChan,channels,powSimBool,cohBool)
% function CalcBadChanAnal(animal,behavior,fileBaseCell,beginTimeMat,nChan,channels,powSimBool,cohBool)
% 
...
% beginTimeMat: vector containing a begin time (in seconds) corresponding
...
if ~exist('fileBaseCell','var') | isempty(fileBaseCell) | ~exist('beginTimeMat','var') | isempty(beginTimeMat)
