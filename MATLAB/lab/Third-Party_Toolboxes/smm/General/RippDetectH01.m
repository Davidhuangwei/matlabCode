...
function [RippleTime, taxis]=RippDetectH01(FileBase,fileExt,totalchannels,ChNums,varargin) %,Mult,shanknumber,drugconditions,drugtimes)
...
if plotBool==1
    ...
    set(gcf,'name',[FileBase '_Ripple_Power_Per_Channel'])
    grid on
end
return
