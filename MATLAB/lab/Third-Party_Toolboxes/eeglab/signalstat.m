...
%   dlabel      - A label for the data ([]: default->'Voltage [µV]')
...
istats=1;	
hs = help('stats');
if ~strcmp(hs(3:20),'Statistics Toolbox')
	disp('signalstat() note: the boxplot requires the MATLAB Statistics Toolbox');
    istats=0;
end
