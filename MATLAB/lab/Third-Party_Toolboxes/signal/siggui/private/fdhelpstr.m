...
'Stability Indicator'
' '
'If this filter has any poles outside the unit circle, the filter is '
'unstable and this indicator appears in red.  If all the poles are inside or '
'on the unit circle, the filter is considered stable.'
' '
