...
% icaML     : ICA by ML with square mixing matrix and no noise.
%
% function [A,S,e]=icaML(X)             Independent component analysis (ICA) using
%                                       maximum likelihood, square mixing matrix and 
%                                       no noise [1] (Infomax). For optimization the 
%                                       BFGS algorithm is used [2]. See code for 
%                                       references.
%                                       
%                                       X  : Mixed signals
%                                       
