...
%
%            >> projdata = icaproj(data,weights,sphere,0,compindex);
% or         >> projdata = icaproj(data,weights,sphere,datamean,compindex);
...
%  'chan_file'= chan file, >> topoplot('example') style {def|0 -> 'chan_file'}
...
% 6-01-97 Colin Humphries & Scott Makeig, CNL / Salk Institute, La Jolla CA
