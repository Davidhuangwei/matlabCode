%
% eegplots - display data in a clinical format without scrolling
%
%    >> eegplots(data, srate, 'chanfile', 'title', ...
...
%'title'       : plot title string {0 -> 'eegplots()'}
...
% Written by Colin Humphries, CNL, Salk Institute 3/97 from eegplot()
...
function y = eegplots(data, srate, channamefile, titleval, yscaling, epoch, linecolor,xstart,vertmark)
