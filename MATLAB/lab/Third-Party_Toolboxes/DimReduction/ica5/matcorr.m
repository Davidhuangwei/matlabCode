...
%
%    >> [corr,indx,indy,corrs] = matcorr(x,y,[rmmean],[method],[weighting]);
%
% Optional inputs:
%
...
%              (no duplications)
% corrs = a square matrix of row-correlation coefficients
...
if n~=q,
   error('The two matrices must have same number of columns.'); 
           % Note: \a is bell
end
...
case 1
	...
	for i=1:m,               % Implements the VAM assignment method
...
case 2   % match in order of max(abs(corr))
