...
%PURPOSE
%
%To compute linear Metric Multi-Dimensional Scaling.
%
%INPUTS
%
...
% s   (vector) Nx1 vecotr of singular values corresponding to the rows of matrix X
...
% Double centered innner product 
B=-0.5*Z*D2*Z;
