...
net = vssminpn(Yn,inpn,kmodel,200,3,1,[0 0 0]); % Note last arguments 'net' not specified.
...
net = vssminpn(Yn,inpn,kmodel,200,3,1,[0 0 0],net); % Note last two arguments left, they will default.
