...
% Undocumented, TODO this option should be renamed consistently with other mesh generation cfgs
...
if nargin<2
  % the triangulation is based on the shape, retriangulate it to the desired accuracy
  [tri1, pnt1] = reducepatch(tri, pnt, 3*cfg.spheremesh);
  tri1 = projecttri(pnt1); % the triangulation is not closed, reconstruct it
  [pnt2, tri2] = msphere(cfg.spheremesh);
