...
if ~isfield(cfg.artfctdef.ecg,'label'),  cfg.artfctdef.ecg.label     = {'ECG'};       end
...
[pindx, pval] = peakdetect2(trace, artfctdef.cutoff, hdr.Fs/2);
artfctdef.qrs = pindx;
...
cfg.version.id = '$Id: artifact_ecg.m,v 1.11 2006/11/29 09:06:36 roboos Exp $';
