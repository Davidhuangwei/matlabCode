...
elseif useheadshape
  ...
  if isstruct(cfg.headshape) && isfield(cfg.headshape, 'pnt') && isfield(cfg.headshape, 'tri')
    % use the headshape surface specified in the configuration
    headshape.pnt = cfg.headshape.pnt;
    headshape.tri = cfg.headshape.tri;
...
cfg.version.id = '$Id: electroderealign.m,v 1.4 2007/02/13 15:12:51 roboos Exp $';
