...
elseif strcmp(varargin{1}.dimord, 'subj_chan_time') && isfield(varargin{1},'avg') %for GA structure with keep individual data
  if ~isfield(cfg, 'xparam'),      cfg.xparam='time';         end
  if ~isfield(cfg, 'zparam'),      cfg.zparam='avg';          end
elseif strcmp(varargin{1}.dimord, 'rpt_chan_time') && isfield(varargin{1}, 'avg')
  if ~isfield(cfg, 'xparam'),      cfg.xparam='time';                  end
  if ~isfield(cfg, 'zparam'),      cfg.zparam='avg';                   end
...
lay = prepare_layout(cfg, varargin);
