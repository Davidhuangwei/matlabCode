...
if issource
  ...
  elseif strcmp(cfg.parameter, 'mom') && ~isfield(varargin{i}.avg, 'csdlabel')
...
cfg.version.id = '$Id: statistics_wrapper.m,v 1.41 2007/05/30 07:08:11 roboos Exp $';
...
% remember the dimension of the source data
if ~isfield(cfg, 'dim'), cfg.dim = dim; end
% remember which voxels are inside the brain
cfg.inside = varargin{1}.inside;
