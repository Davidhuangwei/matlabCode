...
% Copyright (c) 2003-2006, F.C. Donders Centre
%
...
if calcdof
  freq.dof=2*repmat(cumtapcnt,[1,numfoi]);
end;
...
cfg.version.id = '$Id: freqanalysis_mtmfft.m,v 1.36 2007/03/27 11:00:28 ingnie Exp $';
