function [y,f, phi, yerr, phierr, phloc,pow]=mtptchd(varargin)
%function [y, f,  phi, yerr, phierr, phloc,pow]=mtptchd(x,Res, Clu, nFFT,Fs,WinLength,
%         nOverlap,NW,Detrend,nTapers, FreqRange,CluSubset,Segments,pval,MinSpikes);
...
[yo, f, normmat, pow4coh, phloc] = mtptcsd_v1(x,Res, Clu, nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers, FreqRange,CluSubset,Segments,pval,MinSpikes);
...
for Ch1 = 1:nChannelsAll
    for Ch2 = 1:nChannelsAll
        ...
        if (Ch1 == Ch2)
            ...
            pow(:,Ch1, Ch2) = abs(pow4coh(:,Ch1, Ch2));
        else
