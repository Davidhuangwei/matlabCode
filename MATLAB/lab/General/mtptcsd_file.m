function [y, f, normmat, pow4coh, phloc]=mtptcsd_file(FileBase,varargin)
%function [yo, fo, normmat, pow4coh, phloc]=mtptcsd_file(FileBase, nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers, FreqRange,
...
%             normmat(Ch1,Ch2) = nTapers*min(nUsedEegChunks, nUsedUnitsChunks(Ch1-nChannels));
%         elseif Ch2>nChannels && Ch1>nChannels
