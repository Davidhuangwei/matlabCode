function [y, f, t, phi, FStats]=mtcsdglong(varargin);
%function [yo, fo, to, phi, FStats]=mtcsdglong(x,nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers,FreqRange);
    ...
    for Ch1 = 1:nChannels
        for Ch2 = 1:nChannels % don't compute cross-spectra twice
            ...
            if (Ch1 == Ch2)
                ...
                y(iChunks,:,Ch1, Ch2) = permute((abs(tmpy(:,:,Ch1, Ch2).^2)), [2 1 3 4]);
                if nargout>3
