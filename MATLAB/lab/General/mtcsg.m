...
% 
y=(zeros(nFreqBins, nFFTChunks, nChannels, nChannels)); % output array
Periodogram = (zeros(nFreqBins, nTapers, nChannels, nFFTChunks)); % intermediate FFTs
Temp1 = (zeros(nFFT, nTapers, nFFTChunks));
Temp2 = (zeros(nFFT, nTapers, nFFTChunks));
Temp3 = (zeros(nFFT, nTapers, nFFTChunks));
eJ = (zeros(nFFT, nFFTChunks));
