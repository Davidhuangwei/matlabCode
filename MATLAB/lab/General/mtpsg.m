...
%function [yo, fo, to]=mtcsg(x,nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers,FreqRange);
...
for Ch=1:nChannels
	[y(:,:,Ch) f t] = mtcsg(x(:,Ch),nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers, FreqRange);
end
