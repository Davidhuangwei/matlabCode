function [y,f, phi, yerr, phierr, ynorm, ycom, phinorm]=Mymtptchd_segs(varargin)
...
[yo, f, normmat, ynorm, ycom,Periodogram] = mtptcsd_segs(x,Res, Clu, nFFT,Fs,WinLength,WinStep,NW,Detrend,nTapers, FreqRange,CluSubset,Starts,pval,MinSpikes);
