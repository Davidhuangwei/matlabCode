function [y, f, normmat, ynorm, ycom,Periodogram]=Mymtptcsd_segs(varargin)
%function [y, f]=Mymtptcsd_segs(x,Res, Clu, nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers, FreqRange,CluSubset,Starts,pval);
