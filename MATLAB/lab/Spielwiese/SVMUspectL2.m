function cohe = SVMUspectL2(FileBase,spike,mua,PrintBase,varargin)
...
if ~FileExists([FileBase FileOut]) | overwrite
  ...
  [yo, fo, to] = mtchglong(x,nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers,FreqRange);
  %[yo, fo, to, ph]=mtptchglong(mua.eeg,Res, Clu, nFFT,Fs,WinLength,nOverlap,NW,Detrend,nTapers,FreqRange,CluSubset);
