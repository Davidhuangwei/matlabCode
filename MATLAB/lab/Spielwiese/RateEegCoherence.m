function RateEegCoherence(FileBase,rspk,reeg,varargin)
[overwrite, PLOT, PRINTFIG] = DefaultArgs(varargin,{0});


%%%% DOESN'T WORK YET!!!


if ~FileExists([FileBase '.coherence']) | overwrite
  ...
  save([FileBase '.coherence'],'cohe');
  
else
  load([FileBase '.coherence'],'-MAT');
end
