function [strace ltrace] = FindMainTrajNEW2(trials,whl,varargin)
[dd,overwrite] = DefaultArgs(varargin,{1.0,0});
%%
%% SAME AS >> FindMainTrajNEW << but uses mySmooth instead of smooth 
%%
...
%% smooth:
strace(:,1) = mySmooth(ftrace(:,1),3,3);
strace(:,2) = mySmooth(ftrace(:,2),3,3);
