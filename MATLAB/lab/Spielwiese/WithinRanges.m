function out = WithinRanges(x, xRanges,varargin)
[xRangeLabel, Mode] = DefaultArgs(varargin,{[],[]});
%
%function out = WithinRanges(x, xRanges,varargin)
%[xRangeLabel, Mode] = DefaultArgs(varargin,{[],[]});
%
% MODIFIED FOM ANTON's!
%
...
if isempty(xRangeLabel)
  RangeLabel = ones(nRanges, 1);
else
  RangeLabel = xRangeLabel(1:length(Ranges));
end
