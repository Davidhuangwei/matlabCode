% function ThetaWaveICA(FileBase,Waves,nPCA,EegFs,nFet)
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
function ThetaWavesICA(FileBase, Waves, nPCA, varargin)
...
% covariant matrix
[fica1,a1,w1]=fastica(MRSegW(:,find(clu1~=2)),'lastEig',7,'numOfIC', 7);
