...
nlag=30;
cl=ceil(FS/60);
tRes=nRes-randi(cl,length(nRes),1);%repmat(nRes,2,1)-randi(cl,2*length(nRes),1);
pl=zeros(nfr,2,nlag);
...
datat=sprintf('compLFP%d-%d.%dHz.basictests.hphase.bl.mat',Channels,aa);
