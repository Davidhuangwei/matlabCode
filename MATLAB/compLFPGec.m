...
% MECS1=load('g09-20120330.SelectBursts4.[14-250].lfpinterp.RUN3..mat');
% MECS2=load('g09-20120330.SelectBursts4.[14-250].lfpinterp.RUN3.17-32.mat');41-48
...
% BURSTS SELECTION 
bsts=(BurstChan>5 & BurstChan<9)& (BurstFreq>bfr(1)& BurstFreq<bfr(2));
...
ppLFP=zeros(nb,2*nfr);
ppLFP(:,1:2:end)=mean(abs(LFP(:,205:207,1:2:end)),2);
ppLFP(:,2:2:end)=mean(abs(LFP(:,199:201,2:2:end)),2);
ppLFP=sq(ppLFP);
