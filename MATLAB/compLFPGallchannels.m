...
% DG=[37,38,46];%
% rad=42;
selectchannels=[37, 42, 10, 6, 18, 20, 22];
...
datat=sprintf('compLFPch%d.NoiseIndependentT.from%dHz.bf%d-%d.mat',lmch,aa,bfr);
...
set(gca,'XTick',1:2,'Xticklabel',{[channelname{ksch}, ' to CA1lm'],['CA1lm to ', channelname{ksch}]})
